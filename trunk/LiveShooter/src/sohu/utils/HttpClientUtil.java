...
import sohu.data.PostParameter;
...
//        httpGet.setHeader("Accept-Encoding", "gzip, deflate");
    ...
    ///////////////////////////////
	public static String post(String url, PostParameter[] postParameters,
			boolean authenticated,String encoding) throws Exception{
    ...
    private static final <T> T[] copy(T[] source,int len) {
