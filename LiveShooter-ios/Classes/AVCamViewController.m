...
//			[newCaptureVideoPreviewLayer setFrame:CGRectMake(50, 50, 100, 100)];
    ...
    button.frame = CGRectMake(280, 0, 40, 30);
...
- (void)beginUpLoad
{
    PutController * putController = [[PutController alloc] init];
    [self presentModalViewController:putController animated:YES];
    [putController release];
}
